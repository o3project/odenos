...
# packet
echo "------ POST InPacket -------" 
curl -w "$FORMAT" http://$ADDRESS:10080/network0/packets/in -X POST -d '{"type":"InPacket", "node":"node001", "port":"port0011" , "header":{"type":"BasicFlowMatch", "in_node":"node001", "in_port":"port0011"}, "data":"ABCDEFGHIJKLMN", "attributes": {"test_attr":"test_attr_value", "test_attr2":"test_attr_value2", "test_attr3":"test_attr_value3"}}'
curl -w "$FORMAT" http://$ADDRESS:10080/network0/packets/in -X POST -d '{"type":"InPacket", "node":"node001", "port":"port0011" , "header":{"type":"BasicFlowMatch", "in_node":"node001", "in_port":"port0011"}, "data":"ABCDEFGHIJKLMN", "attributes": {"test_attr":"test_attr_value"}}'

echo "------ POST OutPacket -------" 
curl -w "$FORMAT" http://$ADDRESS:10080/network1/packets/out -X POST -d '{"type":"OutPacket", "node":"aggre", "ports":["node003_port0033"] , "ports-except":[] , "header":{"type":"BasicFlowMatch", "in_node":"aggre", "in_port":"node001_port0011"}, "data":"ABCDEFGHIJKLMN", "attributes": {"test_attr":"test_attr_value", "test_attr2":"test_attr_value2", "test_attr3":"test_attr_value3"}}'
curl -w "$FORMAT" http://$ADDRESS:10080/network1/packets/out -X POST -d '{"type":"OutPacket", "node":"aggre", "ports":["node003_port0033"] , "ports-except":[] , "header":{"type":"BasicFlowMatch", "in_node":"aggre", "in_port":"node001_port0011"}, "data":"ABCDEFGHIJKLMN", "attributes": {"test_attr":"test_attr_value"}}'

sleep 1

echo "------ PUT Flow -------" 
curl -w "$FORMAT" http://localhost:10080/network1/flows/flow01 -X PUT -d '{"version":"0","flow_id":"flow01","owner":"logic","enabled":true,"status":"establishing","attributes":{"bandwidth":"0", "req_bandwidth":"0", "latency":"0"},"type":"OFPFlow","idle_timeout":60,"hard_timeout":60,"matches":[{"type":"OFPFlowMatch","in_node":"aggre","in_port":"node001_port0011","eth_src":"ff:aa:ff:aa:ff:aa","eth_dst":"bb:ff:bb:ff:bb:ff","vlan_vid":0,"vlan_pcp":0,"eth_type":2048,"ip_proto":6,"ipv4_src":"10.0.0.1","ipv4_dst":"10.0.0.2","tcp_src":10000,"tcp_dst":10001}],"path":["link0012","link0023"],"edge_actions":{"node1":[{"type":"FlowActionOutput","output":"node003_port0033"},{"type":"OFPFlowActionSetField","match": {"type":"OFPFlowMatch","eth_src":"ab:ff:ab:ff:ab:ff"}}]}}'
curl -w "$FORMAT" http://localhost:10080/network1/flows/flow02 -X PUT -d '{"version":"0","flow_id":"flow02","owner":"logic","enabled":true,"status":"establishing","attributes":{"latency":"0", "req_latency":"0", "bandwidth":"0"},"type":"OFPFlow","idle_timeout":90,"hard_timeout":90,"matches":[{"type":"OFPFlowMatch","in_node":"aggre","in_port":"node003_port0033","eth_src":"bb:ff:bb:ff:bb:ff","eth_dst":"ff:aa:ff:aa:ff:aa","vlan":0,"vlan_pcp":0,"eth_type":2048,"ip_proto":6,"ipv4_src":"10.0.0.2","ipv4_dst":"10.0.0.1","tcp_src":10000,"tcp_dst":10001}],"path":["link0032","link0021"],"edge_actions":{"node1":[{"type":"FlowActionOutput","output":"node001_port0011"},{"type":"OFPFlowActionSetField","match": {"type":"OFPFlowMatch","eth_src":"ff:ab:ff:ab:ff:ab"}}]}}'
...
curl -w "$FORMAT" http://$ADDRESS:10080/network0/topology/nodes?'attributes="oper_status=UP"' -X GET
curl -w "$FORMAT" http://$ADDRESS:10080/network0/topology/nodes?'attributes="physical_id=001"&attributes="oper_status=UP"' -X GET
echo "/////////////////////////////////////////////////"
echo "//////////////// search Port ////////////////////"
echo "/////////////////////////////////////////////////"
curl -w "$FORMAT" http://$ADDRESS:10080/network0/topology/nodes/node001/ports?'attributes="physical_id=0011@001"' -X GET
curl -w "$FORMAT" http://$ADDRESS:10080/network0/topology/nodes/node001/ports?'attributes="oper_status=UP"' -X GET
curl -w "$FORMAT" http://$ADDRESS:10080/network0/topology/nodes/node001/ports?'attributes="physical_id=0011@001"&attributes="oper_status=UP"' -X GET
echo "/////////////////////////////////////////////////"
echo "//////////////// search Link ////////////////////"
echo "/////////////////////////////////////////////////"
curl -w "$FORMAT" http://$ADDRESS:10080/network0/topology/links?'attributes="oper_status=UP"' -X GET
curl -w "$FORMAT" http://$ADDRESS:10080/network0/topology/links?'attributes="cost=0"' -X GET
curl -w "$FORMAT" http://$ADDRESS:10080/network0/topology/links?'attributes="oper_status=UP"&attributes="cost=0"' -X GET
echo "/////////////////////////////////////////////////"
echo "//////////////// search InPacket ////////////////"
echo "/////////////////////////////////////////////////"
curl -w "$FORMAT" http://$ADDRESS:10080/network1/packets/in?'attributes="test_attr=test_attr_value"' -X GET
curl -w "$FORMAT" http://$ADDRESS:10080/network1/packets/in?'attributes="test_attr=test_attr_value"&attributes="test_attr2=test_attr_value2"&attributes="test_attr3=test_attr_value3"' -X GET
echo "/////////////////////////////////////////////////"
echo "//////////////// search OutPacket ///////////////"
echo "/////////////////////////////////////////////////"
curl -w "$FORMAT" http://$ADDRESS:10080/network0/packets/out?'attributes="test_attr=test_attr_value"' -X GET
curl -w "$FORMAT" http://$ADDRESS:10080/network0/packets/out?'attributes="test_attr=test_attr_value"&attributes="test_attr2=test_attr_value2"&attributes="test_attr3=test_attr_value3"' -X GET
echo "/////////////////////////////////////////////////"
echo "//////////////// search OutPacket ///////////////"
echo "/////////////////////////////////////////////////"
curl -w "$FORMAT" http://$ADDRESS:10080/network0/packets/out?'attributes="test_attr=test_attr_value"' -X GET
