...
sleep 1
curl -w "$FORMAT" http://$ADDRESS:10080/network0/topology/nodes/node001 -X PUT -d '{"node_id": "node001", "type": "Node", "version": "0", "ports": {}, "attributes": {"admin_status":"UP", "oper_status":"UP", "physical_id":"001", "vendor":"VENDOR_A"}}'
curl -w "$FORMAT" http://$ADDRESS:10080/network0/topology/nodes/node002 -X PUT -d '{"node_id": "node002", "type": "Node", "version": "0", "ports": {}, "attributes": {"admin_status":"UP", "oper_status":"UP", "physical_id":"002", "vendor":"VENDOR_A"}}'
curl -w "$FORMAT" http://$ADDRESS:10080/network0/topology/nodes/node003 -X PUT -d '{"node_id": "node003", "type": "Node", "version": "0", "ports": {}, "attributes": {"admin_status":"UP", "oper_status":"UP", "physical_id":"003", "vendor":"VENDOR_A"}}'
sleep 1
...
echo "---------------- Delete Connection (lsw <--> network) -------------------"
curl -w "$FORMAT" http://$ADDRESS:10080/systemmanager/connections/lsw -X DELETE

echo "---------------- Delete Connection (aggregator <--> network) -------------------"
...
echo "---------------- Delete Connection (driver <--> network) -------------------"
...
sleep 5
echo "---------------- flow (original network)-------------------"
curl http://$ADDRESS:10080/systemmanager/components/network0/flows -X GET | python -mjson.tool
echo "---------------- flow (aggreagted network)-------------------"
curl http://$ADDRESS:10080/systemmanager/components/network1/flows -X GET | python -mjson.tool

echo "------ original's topology -------" 
curl http://$ADDRESS:10080/systemmanager/components/network0/topology -X GET | python -mjson.tool

echo "------ aggregated's topology -------" 
curl http://$ADDRESS:10080/systemmanager/components/network1/topology -X GET | python -mjson.tool
