...
public class FederatorBoundary extends Boundary {
  ...
  public boolean readValue(Value value) {
    ...
    if (idValue == null || idValue.isNilValue()) {
      log.error(LogMessage.buildLogMessage(50074, LogMessage.getTxid(), "invalid value: id"));
      return false;
    }
    ...
    if (typeValue == null || typeValue.isNilValue()) {
      log.error(LogMessage.buildLogMessage(50074, LogMessage.getTxid(), "invalid value: type"));
      return false;
    }
    ...
    if (network1Value == null || network1Value.isNilValue()) {
      log.error(LogMessage.buildLogMessage(50074, LogMessage.getTxid(), "invalid value: network1"));
      return false;
    }
    ...
    if (node1Value == null || node1Value.isNilValue()) {
      log.error(LogMessage.buildLogMessage(50074, LogMessage.getTxid(), "invalid value: node1"));
      return false;
    }
    ...
    if (port1Value == null || port1Value.isNilValue()) {
      log.error(LogMessage.buildLogMessage(50074, LogMessage.getTxid(), "invalid value: port1"));
      return false;
    }
    ...
    if (network2Value == null || network2Value.isNilValue()) {
      log.error(LogMessage.buildLogMessage(50074, LogMessage.getTxid(), "invalid value: network2"));
      return false;
    }
    ...
    if (node2Value == null || node2Value.isNilValue()) {
      log.error(LogMessage.buildLogMessage(50074, LogMessage.getTxid(), "invalid value: node2"));
      return false;
    }
    ...
    if (port2Value == null || port2Value.isNilValue()) {
      log.error(LogMessage.buildLogMessage(50074, LogMessage.getTxid(), "invalid value: port2"));
      return false;
    }
