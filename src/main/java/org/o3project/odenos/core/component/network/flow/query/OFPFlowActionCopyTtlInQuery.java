...
public class OFPFlowActionCopyTtlInQuery extends FlowActionQuery {

  /**
   * Constructor.
   * @param params action conditions.
   */
  public OFPFlowActionCopyTtlInQuery(Map<String, String> params) {
    super(params);
  }
  ...
  public boolean matchExactly(FlowAction target) {
    if (target == null || !target.getType().equals(
        OFPFlowActionCopyTtlIn.class.getSimpleName())) {
      return false;
    }
    return true;
  }
