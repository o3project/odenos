...
/**
 * Prepares a query for OFPFlowActionPushPbb class.
 */
public class OFPFlowActionPushPbbQuery extends FlowActionQuery {
   ...
   */
  public OFPFlowActionPushPbbQuery(Map<String, String> params) {
    super(params);
  }
  ...
  public boolean matchExactly(FlowAction action) {
    if (action == null || !action.getType().equals(
        OFPFlowActionPushPbb.class.getSimpleName())) {
      return false;
    }
    OFPFlowActionPushPbb target = (OFPFlowActionPushPbb) action;
