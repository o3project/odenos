...
/**
 * An action that pops an MPLS shim header from the packet. Only ethernet type
 * 0x8847(mpls) and 0x8848(mpls-ual) should be used.
 */
public class OFPFlowActionPopMpls extends FlowAction {
   ...
   */
  public OFPFlowActionPopMpls(Integer ethType) {
  ...
  public String getType() {
    return OFPFlowActionPopMpls.class.getSimpleName();
  }
  ...
  public boolean equals(Object obj) {
    ...
    if (!(obj instanceof OFPFlowActionPopMpls)) {
      return false;
    }
    ...
    final OFPFlowActionPopMpls obj2 = (OFPFlowActionPopMpls) obj;
  ...
  @Override
  public OFPFlowActionPopMpls clone() {
    return new OFPFlowActionPopMpls(ethType);
  }
