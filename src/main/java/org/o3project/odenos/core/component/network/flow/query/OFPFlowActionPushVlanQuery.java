...
/**
 * Prepares a query for OFPFlowActionPushVlan class.
 */
public class OFPFlowActionPushVlanQuery extends FlowActionQuery {
   ...
   */
  public OFPFlowActionPushVlanQuery(Map<String, String> params) {
    super(params);
  }
  ...
  public boolean matchExactly(FlowAction action) {
    if (action == null || !action.getType().equals(
        OFPFlowActionPushVlan.class.getSimpleName())) {
      return false;
    }
    OFPFlowActionPushVlan target = (OFPFlowActionPushVlan) action;
