...
/**
 * Prepares a query for OFPFlowActionPushMpls class.
 */
public class OFPFlowActionPushMplsQuery extends FlowActionQuery {
   ...
   */
  public OFPFlowActionPushMplsQuery(Map<String, String> params) {
    super(params);
  }
  ...
  public boolean matchExactly(FlowAction action) {
    if (action == null || !action.getType().equals(
        OFPFlowActionPushMpls.class.getSimpleName())) {
      return false;
    }
    OFPFlowActionPushMpls target = (OFPFlowActionPushMpls) action;
