...
/**
 * Prepares a query for OFPFlowActionPopPbb class.
 */
public class OFPFlowActionPopPbbQuery extends FlowActionQuery {

  /**
   * Constructor.
   * @param params action conditions.
   */
  public OFPFlowActionPopPbbQuery(Map<String, String> params) {
    super(params);
  }
  ...
  public boolean matchExactly(FlowAction target) {
    if (target == null || !target.getType().equals(
        OFPFlowActionPopPbb.class.getSimpleName())) {
      return false;
    }
    return true;
  }
