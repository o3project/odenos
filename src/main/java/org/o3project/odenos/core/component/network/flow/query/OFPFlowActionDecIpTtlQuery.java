...
public class OFPFlowActionDecIpTtlQuery extends FlowActionQuery {

  /**
   * Constructor.
   * @param params action conditions.
   */
  public OFPFlowActionDecIpTtlQuery(Map<String, String> params) {
    super(params);
  }
  ...
  public boolean matchExactly(FlowAction target) {
    if (target == null || !target.getType().equals(
        OFPFlowActionDecIpTtl.class.getSimpleName())) {
      return false;
    }
    return true;
  }
