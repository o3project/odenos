...
/**
 * Prepares a query for BasicFlow class.
 *
 */
public class BasicFlowQuery extends FlowQuery {
   ...
   */
  public BasicFlowQuery(String queriesString) {
    super(queriesString);
  }
  ...
  public boolean matchExactly(BaseObject target) {
    ...
    if (!target.getClass().equals(BasicFlow.class)) {
      return false;
    }

    BasicFlow flow = (BasicFlow) target;
