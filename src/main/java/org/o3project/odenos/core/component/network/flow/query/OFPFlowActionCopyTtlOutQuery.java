...
public class OFPFlowActionCopyTtlOutQuery extends FlowActionQuery {

  /**
   * Constructor.
   * @param params action conditions.
   */
  public OFPFlowActionCopyTtlOutQuery(Map<String, String> params) {
    super(params);
  }
  ...
  public boolean matchExactly(FlowAction target) {
    if (target == null || !target.getType().equals(
        OFPFlowActionCopyTtlOut.class.getSimpleName())) {
      return false;
    }
    return true;
  }
