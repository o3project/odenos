...
/**
 * Prepares a query for OFPFlowActionPopVlan class.
 */
public class OFPFlowActionPopVlanQuery extends FlowActionQuery {

  /**
   * Constructor.
   * @param params action conditions.
   */
  public OFPFlowActionPopVlanQuery(Map<String, String> params) {
    super(params);
  }
  ...
  public boolean matchExactly(FlowAction target) {
    if (target == null || !target.getType().equals(
        OFPFlowActionPopVlanQuery.class.getSimpleName())) {
      return false;
    }
    return true;
  }
