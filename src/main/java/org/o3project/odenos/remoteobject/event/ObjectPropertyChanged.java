...
/**
 * The event to notify of change in ObjectProperty.
 *
 */
public class ObjectPropertyChanged extends BaseObjectChanged<ObjectProperty> {

  public static enum Action {
    add, delete, update;
  }

  public static final String TYPE = "ObjectPropertyChanged";

  /**
   * Constructor.
   */
  public ObjectPropertyChanged() {
