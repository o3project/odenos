 ...
 *
 */
public class ComponentChangedTest {

  private ComponentChanged target;
  ...
  /**
   * Test method for
   * {@link org.o3project.odenos.remoteobject.manager.component.event.ComponentChanged#ComponentChanged()}
   * .
   */
  @Test
  public void testComponentChanged() {
    target = new ComponentChanged();
  ...
  /**
   * Test method for
   * {@link org.o3project.odenos.remoteobject.manager.component.event.ComponentChanged#ComponentChanged(java.lang.String, org.o3project.odenos.remoteobject.ObjectProperty, org.o3project.odenos.remoteobject.ObjectProperty)}
   * .
   */
  @Test
  public void testComponentChangedWithParams() {
    target = new ComponentChanged(action, prev, curr);
