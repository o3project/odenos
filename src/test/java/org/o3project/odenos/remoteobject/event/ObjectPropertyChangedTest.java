 ...
 *
 */
public class ObjectPropertyChangedTest {

  private ObjectPropertyChanged target;
  ...
  /**
   * Test method for
   * {@link org.o3project.odenos.remoteobject.event.ObjectPropertyChanged#ObjectPropertyChanged()}
   * .
   */
  @Test
  public void testObjectPropertyChanged() {
    target = new ObjectPropertyChanged();
    ...
    assertThat(clazz.getName(), is("org.o3project.odenos.remoteobject.ObjectProperty"));
  }

  /**
   * Test method for
   * {@link org.o3project.odenos.remoteobject.event.ObjectPropertyChanged#ObjectPropertyChanged(java.lang.String, org.o3project.odenos.remoteobject.ObjectProperty, org.o3project.odenos.remoteobject.ObjectProperty)}
   * .
   */
  @Test
  public void testObjectPropertyChangedWithParams() {
    target = new ObjectPropertyChanged(action, prev, curr);
