...
public class OFPFlowActionPushMplsQueryTest {

  private OFPFlowActionPushMplsQuery target;
  ...
  public void setUp() throws Exception {
    ...
    target = new OFPFlowActionPushMplsQuery(actions);
  }
  ...
  /**
   * Test method for
   * {@link org.o3project.odenos.core.component.network.flow.query.OFPFlowActionPushMplsQuery#OFPFlowActionPushMplsQuery(java.util.Map)}
   * .
   */
  @Test
  public final void testOFPFlowActionPushMplsQuery() {
    actions = new HashMap<String, String>();
    target = new OFPFlowActionPushMplsQuery(actions);

    assertThat(target, is(instanceOf(OFPFlowActionPushMplsQuery.class)));
    assertThat((Integer) WhiteboxImpl.getInternalState(target, "ethType"), nullValue(Integer.class));
  }

  /**
   * Test method for
   * {@link org.o3project.odenos.core.component.network.flow.query.OFPFlowActionPushMplsQuery#parse()}
   * .
   */
  ...
  /**
   * Test method for
   * {@link org.o3project.odenos.core.component.network.flow.query.OFPFlowActionPushMplsQuery#matchExactly(org.o3project.odenos.core.component.network.flow.basic.FlowAction)}
   * .
   */
  @SuppressWarnings("serial")
  @Test
  public final void testMatchExactlySuccess() {
    ...
    OFPFlowActionPushMpls action = new OFPFlowActionPushMpls();
