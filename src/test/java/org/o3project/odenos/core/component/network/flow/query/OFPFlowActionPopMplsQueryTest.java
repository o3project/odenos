...
public class OFPFlowActionPopMplsQueryTest {

  private OFPFlowActionPopMplsQuery target;
  ...
  public void setUp() throws Exception {
    ...
    target = new OFPFlowActionPopMplsQuery(actions);
  }
  ...
  /**
   * Test method for
   * {@link org.o3project.odenos.core.component.network.flow.query.OFPFlowActionPopMplsQuery#OFPFlowActionPopMplsQuery(java.util.Map)}
   * .
   */
  @Test
  public final void testOFPFlowActionPopMplsQuery() {
    actions = new HashMap<String, String>();
    target = new OFPFlowActionPopMplsQuery(actions);

    assertThat(target, is(instanceOf(OFPFlowActionPopMplsQuery.class)));
    assertThat((Integer) WhiteboxImpl.getInternalState(target, "ethType"), nullValue(Integer.class));
  }

  /**
   * Test method for
   * {@link org.o3project.odenos.core.component.network.flow.query.OFPFlowActionPopMplsQuery#parse()}
   * .
   */
  ...
  /**
   * Test method for
   * {@link org.o3project.odenos.core.component.network.flow.query.OFPFlowActionPopMplsQuery#matchExactly(org.o3project.odenos.core.component.network.flow.basic.FlowAction)}
   * .
   */
  @SuppressWarnings("serial")
  @Test
  public final void testMatchExactlySuccess() {
    ...
    OFPFlowActionPopMpls action = new OFPFlowActionPopMpls();
