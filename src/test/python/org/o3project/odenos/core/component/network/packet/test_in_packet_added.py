...
class InPacketAddedTest(unittest.TestCase):
    value = None
    result = None

    def setUp(self):
        self.target = InPacketAdded("0123")

    def tearDown(self):
        self.target = None

    def test_constractor(self):
        self.assertEqual(self.target._InPacketAdded__id, "0123")
    ...
    def test_create_from_packed(self):
        self.value = {"id": "0456"}
        self.result = InPacketAdded.create_from_packed(self.value)
