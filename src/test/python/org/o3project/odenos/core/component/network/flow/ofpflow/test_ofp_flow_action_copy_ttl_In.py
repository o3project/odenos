...
from org.o3project.odenos.core.component.network.flow.ofpflow.ofp_flow_action_copy_ttl_In\
    import OFPFlowActionCopyTtlIn

import unittest


class OFPFlowActionCopyTtlInTest(unittest.TestCase):

    def setUp(self):
        self.target = OFPFlowActionCopyTtlIn("OFPFlowActionCopyTtlIn")
    ...
    def test_create_from_packed(self):
        ...
        self.result = OFPFlowActionCopyTtlIn.create_from_packed(self.value)
