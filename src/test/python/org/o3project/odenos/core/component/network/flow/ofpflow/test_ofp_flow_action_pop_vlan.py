...
from org.o3project.odenos.core.component.network.flow.ofpflow.ofp_flow_action_pop_vlan\
    import OFPFlowActionPopVlan

import unittest


class OFPFlowActionPopVlanTest(unittest.TestCase):

    def setUp(self):
        self.target = OFPFlowActionPopVlan("OFPFlowActionPopVlan")
    ...
    def test_create_from_packed(self):
        ...
        self.result = OFPFlowActionPopVlan.create_from_packed(self.value)
