...
from org.o3project.odenos.core.component.network.flow.ofpflow.ofp_flow_action_dec_ip_ttl\
    import OFPFlowActionDecIpTtl

import unittest


class OFPFlowActionDecIpTtlTest(unittest.TestCase):

    def setUp(self):
        self.target = OFPFlowActionDecIpTtl("OFPFlowActionDecIpTtl")
    ...
    def test_create_from_packed(self):
        ...
        self.result = OFPFlowActionDecIpTtl.create_from_packed(self.value)
