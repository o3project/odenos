...
from org.o3project.odenos.core.component.network.flow.ofpflow.ofp_flow_action_pop_pbb\
    import OFPFlowActionPopPbb

import unittest


class OFPFlowActionPopPbbTest(unittest.TestCase):

    def setUp(self):
        self.target = OFPFlowActionPopPbb("OFPFlowActionPopPbb")
    ...
    def test_create_from_packed(self):
        ...
        self.result = OFPFlowActionPopPbb.create_from_packed(self.value)
