...
from org.o3project.odenos.core.component.network.flow.ofpflow.ofp_flow_action_push_pbb\
    import OFPFlowActionPushPbb

import unittest


class OFPFlowActionPushPbbTest(unittest.TestCase):

    def setUp(self):
        self.target = OFPFlowActionPushPbb("OFPFlowActionPushPbb",
                                                 1234)
    ...
    def test_create_from_packed(self):
        self.value = {self.target.TYPE: "OFPFlowActionPushPbb",
                      self.target.ETH_TYPE: 4321}

        self.result = OFPFlowActionPushPbb.create_from_packed(self.value)
