...
class EventSubscriptionTest(unittest.TestCase):
    def setUp(self):
        self.target = EventSubscription("subscriber_id", {'k0': 'v0', 'k1': 'v1'})
    ...
    def test_constructor(self):
        ...
        self.assertEqual(self.target.event_filters, {'k0': set(['v', '0']), 'k1': set(['v', '1'])})
    ...
    def test_add_filter(self):
        ...
        self.assertEqual(self.target.event_filters, {'k0': set(['v', '0']), 'k1': set(['v', '1']), 'publisher_id': set(['event_id'])})
    ...
    def test_add_filter_with_existing_event_id(self):
        ...
        self.assertEqual(len(self.target.event_filters), 3)
        self.assertEqual(self.target.event_filters, {'k0': set(['v', '0']), 'k1': set(['v', '1']), 'publisher_id': set(['old_event_id', 'new_event_id'])})
    ...
    def test_remove_filter(self):
        ...
        self.assertEqual(len(self.target.event_filters), 3)
        self.assertEqual(self.target.event_filters, {'k0': set(['v', '0']), 'k1': set(['v', '1']), 'publisher_id': set(['event_id2'])})
    ...
    def test_remove_filter_with_not_existing_publisher_id(self):
        ...
        self.assertEqual(len(self.target.event_filters), 3)
        self.assertEqual(self.target.event_filters, {'k0': set(['v', '0']), 'k1': set(['v', '1']), 'publisher_id': set(['event_id1', 'event_id2'])})
    ...
    def test_create_packed(self):
        ...
        self.assertEqual(result.event_filters, {'k0': set(['v', '0']), 'k1': set(['v', '1'])})
    
    def test_packed_object(self):
        result = self.target.packed_object()
        self.assertEqual(result, {"subscriber_id": "subscriber_id", "event_filters":{'k0': ['0', 'v'], 'k1': ['1', 'v']}})
